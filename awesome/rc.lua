...
beautiful.init("/home/ppp/.config/awesome/themes/foo/theme.lua")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "1 CTF", 2, 3, 4, 5, " 6 server ", " 7 web ", " 8 mail ", " 9 musique ", " 0 irc " }, s, layouts[1])
end
-- }}}
...
--
-- Battery Gradient
batgradient = awful.widget.progressbar()
batgradient:set_width(10)
batgradient:set_height(20)
batgradient:set_vertical(true)
batgradient:set_background_color("#1c1d1c")
batgradient:set_border_color(nil)
batgradient:set_color("#8d8a4b")
--batgradient:set_gradient_colors({ "#AECF96", "#88A175", "#FF5656" })
vicious.register(batgradient, vicious.widgets.bat, "$2", 61, "BAT0")

-- Battery Textbox
battext = widget({ type = "textbox" })
battext.width = 90
vicious.register(battext, vicious.widgets.bat, "$3 : : $2 %", 61, "BAT0")
...
awful.util.spawn_with_shell("run_once /usr/lib/policykit-1/polkitd --no-debug")
awful.util.spawn_with_shell("run_once /usr/lib/policykit-1-gnome/polkit-gnome-authentication-agent-1")
awful.util.spawn_with_shell("run_once /usr/bin/python /usr/bin/system-config-printer-applet")
